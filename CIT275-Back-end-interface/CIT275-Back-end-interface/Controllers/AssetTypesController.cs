...
namespace CIT275_Back_end_interface.Controllers
{
    public class AssetTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Description")] AssetType assetType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Description")] AssetType assetType)
        {
            if (ModelState.IsValid)
            {
